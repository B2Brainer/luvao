...
class ProductActions(Generic[_PrismaModelT]):
    ...
    async def find_first(
        ...
        -------
        ```py
        # find the second Product record ordered by the name field
    ...
    async def find_first_or_raise(
        ...
        -------
        ```py
        # find the second Product record ordered by the id field
...
class StoreActions(Generic[_PrismaModelT]):
    __slots__ = (
        '_client',
        '_model',
    )
    ...
    async def query_raw(
        ...
        *args
        ...
        -------
        ```py
        users = await Store.prisma().query_raw(
    ...
    async def query_first(
        ...
        *args
        ...
        -------
        ```py
        user = await Store.prisma().query_first(
            'SELECT * FROM Store WHERE name = $1',
            'fjfddhigg',
        )
        ```
        """
    ...
    async def create(
        self,
        data: types.StoreCreateInput,
        include: Optional[types.StoreInclude] = None
    ) -> _PrismaModelT:
        ...
        data
            Store record data
        include
            Specifies which relations should be loaded on the returned Store model
        ...
        -------
        ```py
        # create a Store record from just the required fields
        store = await Store.prisma().create(
            data={
                # data to create a Store record
                'name': 'hjaecfifb',
            },
        )
        ```
    ...
    async def create_many(
        self,
        data: List[types.StoreCreateWithoutRelationsInput],
        *,
        skip_duplicates: Optional[bool] = None,
    ) -> int:
        """Create multiple Store records at once.
        ...
        -------
        ```py
        total = await Store.prisma().create_many(
            data=[
                {
                    # data to create a Store record
                    'name': 'cbbbjbfcii',
    ...
    async def delete(
        self,
        where: types.StoreWhereUniqueInput,
        include: Optional[types.StoreInclude] = None
    ) -> Optional[_PrismaModelT]:
        ...
        ----------
        where
            Store filter to select the record to be deleted, must be unique
        include
            Specifies which relations should be loaded on the returned Store model
        ...
        -------
        ```py
        store = await Store.prisma().delete(
            where={
                'id': 'bgeecijdgg',
            },
        )
    ...
    async def find_unique(
        ...
        """Find a unique Store record.

        Parameters
        ----------
        where
            Store filter to find the record, must be unique
        include
            Specifies which relations should be loaded on the returned Store model
        ...
        -------
        ```py
        store = await Store.prisma().find_unique(
            where={
                'id': 'bdiicjafbj',
            },
        )
    ...
    async def find_unique_or_raise(
        ...
        """Find a unique Store record. Raises `RecordNotFoundError` if no record is found.
        ...
        -------
        ```py
        store = await Store.prisma().find_unique_or_raise(
            where={
                'id': 'bgehebiafc',
            },
        )
    ...
    async def find_many(
        ...
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.StoreWhereInput] = None,
        cursor: Optional[types.StoreWhereUniqueInput] = None,
        include: Optional[types.StoreInclude] = None,
        order: Optional[Union[types.StoreOrderByInput, List[types.StoreOrderByInput]]] = None,
        distinct: Optional[List[types.StoreScalarFieldKeys]] = None,
    ) -> List[_PrismaModelT]:
        """Find multiple Store records.
        ...
        ----------
        take
            Limit the maximum number of Store records returned
        skip
            Ignore the first N results
        where
            Store filter to select records
        cursor
            Specifies the position in the list to start returning results from, (typically an ID field)
        include
            Specifies which relations should be loaded on the returned Store model
        order
            Order the returned Store records by any field
        distinct
            Filter Store records by either a single distinct field or distinct combinations of fields

        Returns
        -------
        List[prisma.models.Store]
            The list of all Store records that could be found
        ...
        -------
        ```py
        # find the first 10 Store records
        stores = await Store.prisma().find_many(take=10)

        # find the first 5 Store records ordered by the id field
        stores = await Store.prisma().find_many(
            take=5,
            order={
                'id': 'desc',
            },
    ...
    async def find_first(
        ...
        skip
            Ignore the first N records
        where
            Store filter to select the record
        cursor
            Specifies the position in the list to start returning results from, (typically an ID field)
        include
            Specifies which relations should be loaded on the returned Store model
        ...
        -------
        prisma.models.Store
            The first Store record found, matching the given arguments
        None
            No record could be found
        ...
        -------
        ```py
        # find the second Store record ordered by the name field
        store = await Store.prisma().find_first(
            skip=1,
            order={
                'name': 'desc',
            },
    ...
    async def find_first_or_raise(
        ...
        """Find a single Store record. Raises `RecordNotFoundError` if no record was found.
        ...
        -------
        ```py
        # find the second Store record ordered by the id field
        store = await Store.prisma().find_first_or_raise(
            skip=1,
            order={
                'id': 'desc',
            },
    ...
    async def update(
        ...
        ----------
        data
            Store record data specifying what to update
        where
            Store filter to select the unique record to create / update
        include
            Specifies which relations should be loaded on the returned Store model
        ...
        -------
        ```py
        store = await Store.prisma().update(
            where={
                'id': 'bghffegacj',
            },
            data={
                # data to update the Store record to
            },
        )
        ```
        """
    ...
    async def upsert(
        ...
        -------
        prisma.models.Store
            The created or updated Store record
        ...
        -------
        ```py
        store = await Store.prisma().upsert(
            where={
                'id': 'bhghchehcc',
            },
            data={
    ...
    async def update_many(
        self,
        data: types.StoreUpdateManyMutationInput,
        where: types.StoreWhereInput,
    ) -> int:
        """Update multiple Store records

        Parameters
        ----------
        data
            Store data to update the selected Store records to
        where
            Filter to select the Store records to update

        Returns
        -------
        int
            The total number of Store records that were updated
        ...
        -------
        ```py
        # update all Store records
        total = await Store.prisma().update_many(
            data={
                'name': 'dcgchcbbf'
            },
            where={}
    ...
    async def count(
        ...
        """Count the number of Store records present in the database

        Parameters
        ----------
        select
            Select the Store fields to be counted
        take
            Limit the maximum result
        skip
            Ignore the first N records
        where
            Store filter to find records
        cursor
            Specifies the position in the list to start counting results from, (typically an ID field)
        order
            This parameter is deprecated and will be removed in a future release
        ...
        prisma.types.StoreCountAggregateOutput
            Data returned when `select` is used, the fields present in this dictionary will
            match the fields passed in the `select` argument
        ...
        ```py
        # total: int
        total = await Store.prisma().count()

        # results: prisma.types.StoreCountAggregateOutput
        results = await Store.prisma().count(
            select={
                '_all': True,
                'id': True,
            },
    ...
    async def count(
        self,
        select: types.StoreCountAggregateInput,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.StoreWhereInput] = None,
        cursor: Optional[types.StoreWhereUniqueInput] = None,
    ) -> types.StoreCountAggregateOutput:
        ...

    async def count(
        self,
        select: Optional[types.StoreCountAggregateInput] = None,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        where: Optional[types.StoreWhereInput] = None,
        cursor: Optional[types.StoreWhereUniqueInput] = None,
    ) -> Union[int, types.StoreCountAggregateOutput]:
        """Count the number of Store records present in the database
        ...
        if select is None:
            ...
            return cast(types.StoreCountAggregateOutput, resp['data']['result']['_count'])

    async def delete_many(
        self,
        where: Optional[types.StoreWhereInput] = None
    ) -> int:
        """Delete multiple Store records.

        Parameters
        ----------
        where
            Optional Store filter to find the records to be deleted

        Returns
        -------
        int
            The total number of Store records that were deleted
        ...
        total = await Store.prisma().delete_many()
        ```
        """
        resp = await self._client._execute(
            method='delete_many',
    ...
    async def group_by(
        self,
        by: List['types.StoreScalarFieldKeys'],
        *,
        where: Optional['types.StoreWhereInput'] = None,
        take: Optional[int] = None,
        skip: Optional[int] = None,
        avg: Optional['types.StoreAvgAggregateInput'] = None,
        sum: Optional['types.StoreSumAggregateInput'] = None,
        min: Optional['types.StoreMinAggregateInput'] = None,
        max: Optional['types.StoreMaxAggregateInput'] = None,
        having: Optional['types.StoreScalarWhereWithAggregatesInput'] = None,
        count: Optional[Union[bool, 'types.StoreCountAggregateInput']] = None,
        order: Optional[Union[Mapping['types.StoreScalarFieldKeys', 'types.SortOrder'], List[Mapping['types.StoreScalarFieldKeys', 'types.SortOrder']]]] = None,
    ) -> List['types.StoreGroupByOutput']:
        """Group Store records by one or more field values and perform aggregations
        each group such as finding the average.

        Parameters
        ----------
        by
            List of scalar Store fields to group records by
        where
            Store filter to select records
        take
            Limit the maximum number of Store records returned
        ...
        Returns
        -------
        List[prisma.types.StoreGroupByOutput]
            A list of dictionaries representing the Store record,
            this will also have additional fields present if aggregation arguments
            are used (see the above parameters)
        ...
        -------
        ```py
        # group Store records by id values
        # and count how many records are in each group
        results = await Store.prisma().group_by(
            ['id'],
            count=True,
        )
        ```

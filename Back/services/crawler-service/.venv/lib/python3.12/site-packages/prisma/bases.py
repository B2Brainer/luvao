...
class BaseStore(_PrismaModel):
    __prisma_model__: ClassVar[Literal['Store']] = 'Store'  # pyright: ignore[reportIncompatibleVariableOverride]

    @classmethod
    def prisma(cls: Type[_PrismaModelT], client: Optional['Prisma'] = None) -> 'actions.StoreActions[_PrismaModelT]':
        from .client import get_client

        return actions.StoreActions[_PrismaModelT](client or get_client(), cls)
